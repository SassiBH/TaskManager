<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="TasksPage.aspx.cs" Inherits="TasksManager.TasksPage" %>
...
.custom-table thead {
    background: linear-gradient(90deg, #1e3a8a, #6c757d); 
    color: #fff;
}
