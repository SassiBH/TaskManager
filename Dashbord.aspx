<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dashbord.aspx.cs" Inherits="TasksManager.Dashbord" %>
                ...
                <asp:GridView ID="gvTasks" runat="server" AutoGenerateColumns="False" CssClass="custom-table" OnRowCommand="gvTasks_RowCommand">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Actions">
                            <ItemTemplate>
                                <button type="button" class="btn-edit" data-bs-toggle="modal" data-bs-target="#addTaskModal" onclick="fillModal('<%# Eval("TaskID") %>', '<%# Eval("Title") %>', '<%# Eval("Description") %>', '<%# Eval("StartDate") %>', '<%# Eval("EndDate") %>', '<%# Eval("IsActive") %>')">Edit</button>
...
<div class="modal fade" id="addAchievmentModal" tabindex="-1" aria-labelledby="addTaskModalLabel" aria-hidden="true">
    ...
    <script>
        ...
        function fillModal(taskId, title, description, startDate, endDate, isActive) {
        ...
        function validateSettingsForm() {
            ...
            if (!noLeadingSpacesRegex.test(firstName) || !noLeadingSpacesRegex.test(lastName) ||
                ...
                alert("Fields cannot contain spaces at the beginning.");
                return false;
            }
